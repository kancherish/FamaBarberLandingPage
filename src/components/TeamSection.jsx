    ...
    <div class="container px-6 py-10 mx-auto">
        <div class="xl:flex xl:items-center xL:-mx-4">
            <div class="xl:w-1/2 xl:mx-4">
                <h1 class="text-2xl font-semibold text-gray-800 capitalize lg:text-3xl dark:text-white">Our Barbers</h1>

                <p class="max-w-2xl mt-4 text-gray-500 dark:text-gray-300">
                    Lorem ipsum dolor sit amet consectetur adipisicing elit. Dignissimos, sapiente.
                </p>
            </div>
            ...
            <div class="grid grid-cols-1 gap-8 mt-8 xl:mt-0 xl:mx-4 xl:w-1/2 md:grid-cols-2">
                <div>
                    ...
                    <p class="mt-2 text-gray-500 capitalize dark:text-gray-300">Barber</p>
                </div>
                ...
                <div>
                    ...
                    <p class="mt-2 text-gray-500 capitalize dark:text-gray-300">Hair Artist</p>
                </div>
            </div>
        </div>
    </div>
