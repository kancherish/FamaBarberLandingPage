...
const services = [
  {
    title: "HairCut",
    content: "Our skilled barbers deliver precision haircuts tailored to your style and face shape. From classic cuts to modern fades, we ensure you leave looking sharp and confident",
  ...
  {
    title: "Beard Service",
    content: "Maintain your facial hair with our premium beard services. Our barbers specialize in perfect beard shaping, precise trims, and luxurious hot towel shaves for the ultimate grooming experience.",
    icon: <svg width="36" height="36" viewBox="0 0 36 36" fill="none" xmlns="http://www.w3.org/2000/svg">
  ...
  },
  {
    ...
    content: "Enhance your look with our premium barbering services including expert hair coloring, revitalizing scalp treatments, and styling for special occasions when you need to look your absolute best.",
    icon: <svg width="36" height="36" viewBox="0 0 36 36" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <div className="container mx-auto px-4">
        ...
        >
          {services.map((item, index) => (
            ...
            >
              <div className="group mb-9 rounded-[20px] border border-gray-800 bg-gray-800 p-10 transition-all duration-300 hover:scale-[1.02] hover:border-indigo-400 hover:shadow-xl">
                <div className="mb-8 flex h-[70px] w-[70px] items-center justify-center rounded-2xl bg-indigo-600 transition-all duration-300 group-hover:bg-indigo-500 group-hover:shadow-lg">
                  <div className="transition-transform duration-300 group-hover:scale-110">
                    {item.icon}
                  </div>
                </div>
                <h3 className="mb-[14px] text-2xl font-semibold text-white">
                  {item.title}
                </h3>
